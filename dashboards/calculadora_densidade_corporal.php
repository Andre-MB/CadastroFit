            ...
            <table class="student-table">
                ...
                <?php if (!empty($data_escolhida)): ?>
                    ...
                    <tr>
                        ...
                        <td><strong>Peitoral:</strong></td>
                        <td><?= $antropometria['peitoral'] ?? 'N/A' ?></td>
                    </tr>
                    <tr>
                        <td> <strong>Abdomem:</strong></td>
                        <td><?= $antropometria['abdomem']?></td>
                    </tr>
                    <tr>
                        <td><strong>Coxa Medial:</strong></td>
                        <td><?= $antropometria['coxa_medial']?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th colspan="2" class="texto-centralizado"><h3>Testes físicos</h3></th>
                    </tr>
                    <tr>
