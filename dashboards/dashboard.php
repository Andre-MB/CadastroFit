    ...
    <div class="container">
        ...
        <div class="user_config">
            ...
            <div class="exit_config">
                <a class="config" href="<?php echo $_SESSION['isadmin'] ? 'dashboard_usuarios.php?id=' . $_SESSION['usuario_id'] : '../resetPassword/trocaSenha.php?id=' . $_SESSION['usuario_id']; ?>"><ion-icon name="person"></ion-icon></a>
